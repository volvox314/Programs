...
var ballColor = 'rgb(' + ballColorValue + ',' + ballColorValue + ',' + ballColorValue + ')';
var count = 0;
...
function changeColor() {
    ...
    ballColor = 'rgb(' + ballColorValue + ',' + ballColorValue + ',' + ballColorValue + ')';
}

function collisionDetection(ID) {
    for (var c = 0; c < brickColumnCount; c++) {
        for (var r = 0; r < brickRowCount; r++) {
            var b = bricks[c][r];
            if (!b.state) continue;
